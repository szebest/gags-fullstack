...
export default function CommentsContainer({comments, callForMore, sectionName, ready, updateComment, sendComment, refreshComments, postID}) {
        ...
        <>
            ...
            <div className={classes.container}>
                <div className={classes.commentWrapper}>
                    {comments && comments.map((comment, index) => <Comment updateThisComment={updateComment} postID={postID} comment={comment} sendComment={sendComment} index={index} key={comment._id} />)}
                </div>
            </div>
